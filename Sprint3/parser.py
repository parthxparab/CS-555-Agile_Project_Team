    ...
    for i in range(len(df_fam)):
        for j in range(i,len(df_fam)):
            if(df_fam['Wife Name'][i] == df_fam['Wife Name'][j] and df_fam['ID'][i] != df_fam['ID'][j]):
                ...
                iMarry = (df_fam.loc[df_fam['ID'] == df_fam['ID'][i]].values[0])[1]
                iDiv = (df_fam.loc[df_fam['ID'] == df_fam['ID'][i]].values[0])[2]
                jMarry = (df_fam.loc[df_fam['ID'] == df_fam['ID'][j]].values[0])[1]
                jDiv = (df_fam.loc[df_fam['ID'] == df_fam['ID'][j]].values[0])[2]
                if((iMarry < jMarry and iDiv == 'NA')or (iMarry < jMarry and iDiv > jMarry)):
                    print_line = 'ERROR: FAMILY: US11: '+str(i)+': '+df_fam['ID'][i] +': '+df_fam['Wife Name'][i] +" is married to "+df_fam['Husband Name'][i]+ "and "+ df_fam['Husband Name'][j]+ " at the same time"
                    count = count + 1
                    error.append(print_line)
            ...
            if(df_fam['Husband Name'][i] == df_fam['Husband Name'][j] and df_fam['ID'][i] != df_fam['ID'][j]):
                ...
                jDiv = (df_fam.loc[df_fam['ID'] == df_fam['ID'][j]].values[0])[2]            
                if((iMarry < jMarry and iDiv == 'NA')or (iMarry < jMarry and iDiv > jMarry)):
                    print_line = 'ERROR: FAMILY: US11: '+str(i)+': '+df_fam['ID'][i] +': '+df_fam['Husband Name'][i]+" is married to "+df_fam['Wife Name'][i]+ "and "+ df_fam['Wife Name'][j]+ " at the same time"
                    count = count + 1
                    error.append(print_line)
        ...
        if(len(df_fam['Children'][i]) > 0):
            if(len(df_indi.loc[df_indi['Spouce'] == df_fam['ID'][i]].values) > 0 and df_indi.loc[df_indi['Spouce'] == df_fam['ID'][i]].values[0][8] != 'NA' and df_indi.loc[df_indi['Spouce'] == df_fam['ID'][i]].values[0][4] != 'NA' and len(df_indi.loc[df_indi['Spouce'] == df_fam['ID'][i]].values[0][8]) > 0 and df_indi['Alive'].loc[df_indi['Spouce'] == df_fam['ID'][i]].values[0] == True):
                ...
                if(df_indi.loc[df_indi['Spouce'] == df_fam['ID'][i]].values[0][2] == 'F' and (df_indi.loc[df_indi['Spouce'] == df_fam['ID'][i]].values[0][4] - df_indi.loc[df_indi['Child'] == df_fam['ID'][i]].values[0][4]) > 60):
                    print_line = 'ERROR: FAMILY: US12: '+str(i)+': '+df_indi.loc[df_indi['Spouce'] == df_fam['ID'][i]].values[0][0]+': '+'Mother\'s age ' + str(df_indi.loc[df_indi['Spouce'] == df_fam['ID'][i]].values[0][4]) + ' is more than 60 years older than her child ' + str(df_indi.loc[df_indi['Child'] == df_fam['ID'][i]].values[0][4])
                    count = count + 1
                    error.append(print_line)
                    ...
                    print_line = 'ERROR: FAMILY: US12: '+str(i)+': '+df_indi.loc[df_indi['Spouce'] == df_fam['ID'][i]].values[0][0]+': '+'Father\'s age ' + str(df_indi.loc[df_indi['Spouce'] == df_fam['ID'][i]].values[0][4]) + ' is more than 60 years older than his child with age' + str(df_indi.loc[df_indi['Child'] == df_fam['ID'][i]].values[0][4])
                    count = count + 1
                    error.append(print_line)
    if(count > 0):
        return (error)
